...
def run_cuj(page):
    ...
    page.click("#step-1 button:has-text('Siguiente')")
    page.wait_for_timeout(1000)
    ...
    # Step 3: Branch Commitments (Individual branch navigation)
    page.wait_for_selector("text=Sucursal 1 de 1", state="visible")
    page.click("#c1-0")
    ...
    page.screenshot(path="verification/screenshots/step3_branch_nav.png")
    # Be more specific for the button in step 3
    page.click("#branchCommitmentsContainer button:has-text('Siguiente')")
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path="verification/screenshots/final_review.png")
    page.wait_for_timeout(1000)
